    ...
    return (
        <div className="text-white min-h-[80vh] flex flex-col sm:items-center sm:p-0 p-10 sm:flex-row">
            ...
            <div className="flex-1 flex flex-col gap-3">
                ...
                <div className="divider w-[300px] divider-neutral">atau</div>
                <RegisterModal />
                <div className="w-[300px] text-[10px] text-gray-500">
                    Dengan mendaftar, Anda menyetujui <span className="text-blue-500 hover:underline cursor-pointer">Persyaratan Layanan</span> dan <span className="text-blue-500 hover:underline cursor-pointer">Kebijakan Privasi</span>, termasuk <span className="text-blue-500 hover:underline cursor-pointer">Penggunaan Kuki</span>.
                </div>
